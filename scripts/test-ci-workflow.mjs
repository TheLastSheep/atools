...
assert.equal(workflow.match(/dtolnay\/rust-toolchain@1\.97\.0/g)?.length, 5);
...
assert.match(workflow, /^  pasteboardpro-search-performance:/m);
assert.match(workflow, /benchmark_pasteboard_search --release/);
assert.match(workflow, /pasteboardpro-atools-search-\$\{\{ github\.sha \}\}/);
